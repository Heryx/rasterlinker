...
def build_grid_options_controls(
    ...
    # Two rows keep the box compact without reducing readability.
    flags_grid.addWidget(snap_checkbox, 0, 0, 1, 1)
    flags_grid.addWidget(ortho_checkbox, 0, 1, 1, 1)
    flags_grid.addWidget(ortho_base_checkbox, 1, 0, 1, 1)
    flags_grid.addWidget(keep_area_checkbox, 1, 1, 1, 1)
    ...
    export_button.setMinimumHeight(20)
    ...
    orientation_status_label.setMinimumHeight(14)
